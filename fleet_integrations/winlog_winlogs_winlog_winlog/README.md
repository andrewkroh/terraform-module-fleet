...
| <a name="input_fleet_package_version"></a> [fleet\_package\_version](#input\_fleet\_package\_version) | Version of the winlog package to use. | `string` | `"1.16.0"` | no |
...
| <a name="input_providers"></a> [providers](#input\_providers) | A list of providers (source names) to include. | `list(string)` | `null` | no |
