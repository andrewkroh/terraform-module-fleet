...
| <a name="input_fleet_package_version"></a> [fleet\_package\_version](#input\_fleet\_package\_version) | Version of the aws package to use. | `string` | `"3.5.0"` | no |
...
| <a name="input_initial_interval"></a> [initial\_interval](#input\_initial\_interval) | How far back to pull the AWS Inspector Findings from AWS. NOTE: Supported units for this parameter are h/m/s. | `string` | `"24h"` | no |
| <a name="input_interval"></a> [interval](#input\_interval) | Interval to fetch AWS Inspector Findings from AWS. NOTE: Supported units for this parameter are h/m/s. | `string` | `"1m"` | no |
