...
| <a name="input_query"></a> [query](#input\_query) | This is an additional FQL query that can be included in requests to the API. You should not include any reference to the `timestamp` property. See the [FalconPy documentation](https://www.falconpy.io/Usage/Falcon-Query-Language.html) for details. | `string` | `null` | no |
