...
| <a name="input_initial_interval"></a> [initial\_interval](#input\_initial\_interval) | How far back to pull the AWS Security Hub CSPM Findings from AWS. (Initial Interval should be greater than 1 hour.) | `string` | `"24h"` | no |
| <a name="input_interval"></a> [interval](#input\_interval) | Interval to fetch AWS Security Hub CSPM Findings from AWS. (Interval should be greater than 1 hour.) | `string` | `"1h"` | no |
