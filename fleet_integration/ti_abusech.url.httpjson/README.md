...
| <a name="input_fleet_package_version"></a> [fleet\_package\_version](#input\_fleet\_package\_version) | Version of the ti\_abusech package to use. | `string` | `"1.24.1"` | no |
...
| <a name="input_url"></a> [url](#input\_url) | n/a | `string` | `"https://urlhaus-api.abuse.ch/v1/urls/recent/"` | no |
