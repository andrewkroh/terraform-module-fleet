...
| <a name="input_batch_size"></a> [batch\_size](#input\_batch\_size) | Batch size for the response of the Recorded Future API. Maximum batch size can be 1000. Using lesser batch size would be recommended to avoid http timeout. | `number` | `100` | no |
