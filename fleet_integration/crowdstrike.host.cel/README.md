...
| <a name="input_fleet_package_version"></a> [fleet\_package\_version](#input\_fleet\_package\_version) | Version of the crowdstrike package to use. | `string` | `"2.10.0"` | no |
...
| <a name="input_query"></a> [query](#input\_query) | This is an additional FQL query that may be included in requests to the API. You should not include any reference to the `modified_timestamp` property. See the [FalconPy documentation](https://www.falconpy.io/Usage/Falcon-Query-Language.html) for details. | `string` | `null` | no |
