...
| <a name="input_application_name_for_url"></a> [application\_name\_for\_url](#input\_application\_name\_for\_url) | Do not modify. The application name used to build the endpoint URL. | `string` | `"admin"` | no |
