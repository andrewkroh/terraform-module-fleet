...
| <a name="input_fleet_package_version"></a> [fleet\_package\_version](#input\_fleet\_package\_version) | Version of the m365\_defender package to use. | `string` | `"2.0.0"` | no |
| <a name="input_initial_interval"></a> [initial\_interval](#input\_initial\_interval) | How far back in time to look for alerts the first time running. Default is 1 week. Supported units for this parameter are h/m/s. | `string` | `"168h"` | no |
| <a name="input_interval"></a> [interval](#input\_interval) | The interval between requests to the HTTP API. Supported units for this parameter are h/m/s. | `string` | `"5m"` | no |
...
| <a name="input_request_url"></a> [request\_url](#input\_request\_url) | URL of API endpoint' | `string` | `"https://api.security.microsoft.com"` | no |
...
| <a name="input_tags"></a> [tags](#input\_tags) | n/a | `list(string)` | <pre>[<br>  "m365_defender",<br>  "forwarded"<br>]</pre> | no |
