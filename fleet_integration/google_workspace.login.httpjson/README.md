...
| <a name="input_application_name_for_url"></a> [application\_name\_for\_url](#input\_application\_name\_for\_url) | Do not modify. The application name used to build the endpoint URL. | `string` | `"login"` | no |
...
| <a name="input_tags"></a> [tags](#input\_tags) | n/a | `list(string)` | <pre>[<br>  "forwarded",<br>  "google_workspace-login"<br>]</pre> | no |
