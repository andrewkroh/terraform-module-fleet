...
| <a name="input_fleet_package_version"></a> [fleet\_package\_version](#input\_fleet\_package\_version) | Version of the barracuda\_cloudgen\_firewall package to use. | `string` | `"1.8.0"` | no |
