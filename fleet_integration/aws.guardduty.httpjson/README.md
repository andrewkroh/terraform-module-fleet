...
| <a name="input_detector_id"></a> [detector\_id](#input\_detector\_id) | Unique ID of the object that represents the GuardDuty service. Detector ID of the master account. | `string` | n/a | yes |
