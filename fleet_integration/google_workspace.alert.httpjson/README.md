...
| <a name="input_fleet_package_version"></a> [fleet\_package\_version](#input\_fleet\_package\_version) | Version of the google\_workspace package to use. | `string` | `"2.29.0"` | no |
...
| <a name="input_page_size"></a> [page\_size](#input\_page\_size) | Page Size for the response of the Google Workspace API. | `string` | `1000` | no |
