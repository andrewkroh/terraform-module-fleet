...
|------|-------------|------|---------|:--------:|
| <a name="input_alert_center_api_host"></a> [alert\_center\_api\_host](#input\_alert\_center\_api\_host) | The Google Workspace Alert Center API Host. The path will be automatically set. | `string` | `"https://alertcenter.googleapis.com"` | no |
...
| <a name="input_page_size"></a> [page\_size](#input\_page\_size) | Page Size for the response of the Google Workspace API. | `number` | `1000` | no |
| <a name="input_preserve_duplicate_custom_fields"></a> [preserve\_duplicate\_custom\_fields](#input\_preserve\_duplicate\_custom\_fields) | Preserve custom fields for all ECS mappings. | `bool` | `false` | no |
...
| <a name="input_tags"></a> [tags](#input\_tags) | n/a | `list(string)` | <pre>[<br>  "forwarded",<br>  "google_workspace-alert"<br>]</pre> | no |
