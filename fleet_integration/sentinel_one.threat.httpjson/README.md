...
|------|-------------|------|---------|:--------:|
| <a name="input_api_token"></a> [api\_token](#input\_api\_token) | API Token with API Access Level type. | `string` | n/a | yes |
...
| <a name="input_fleet_package_version"></a> [fleet\_package\_version](#input\_fleet\_package\_version) | Version of the sentinel\_one package to use. | `string` | `"1.37.0"` | no |
...
| <a name="input_url"></a> [url](#input\_url) | SentinelOne console URL. | `string` | n/a | yes |
