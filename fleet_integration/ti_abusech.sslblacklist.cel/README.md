...
| <a name="input_tags"></a> [tags](#input\_tags) | n/a | `list(string)` | <pre>[<br>  "forwarded",<br>  "abusech-sslblacklist"<br>]</pre> | no |
| <a name="input_url"></a> [url](#input\_url) | Base URL of the abuse.ch SSLBL API to collect malicious SSL blacklisted certificates identified by SSLBL. | `string` | `"https://sslbl.abuse.ch/blacklist/sslblacklist.csv"` | no |
