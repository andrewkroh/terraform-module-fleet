...
| <a name="input_fleet_package_version"></a> [fleet\_package\_version](#input\_fleet\_package\_version) | Version of the ti\_threatconnect package to use. | `string` | `"1.7.0"` | no |
...
| <a name="input_ssl_yaml"></a> [ssl\_yaml](#input\_ssl\_yaml) | Configuration for SSL communication if needed. | `string` | `null` | no |
